...
public class Exercise_Body_Parts extends AppCompatActivity {
    ...
    private void coreButton() {
        ...
        core.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Exercise_Body_Parts.this, Core.class));
            }
        });
    }
    ...
    /**
     * This method adds an OnClick listener to the traps button to open the trap exercises layout file
     * */
    private void trapsButton() {
        ...
        traps.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Exercise_Body_Parts.this, Traps.class));
            }
        });
    }

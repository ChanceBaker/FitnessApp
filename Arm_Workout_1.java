...
public class Arm_Workout_1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_arm_workout_1);
        saveButton();
    }
    ...
    private void saveButton() {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CheckBox ex4Check = (CheckBox) findViewById(R.id.exercise_4_checkbox);
                CheckBox ex5Check = (CheckBox) findViewById(R.id.exercise_5_checkbox);

                TableRow message = (TableRow) findViewById(R.id.message);
                TextView messageText = (TextView) findViewById(R.id.messageText);
                if(ex1Check.isChecked() || ex2Check.isChecked() || ex3Check.isChecked()|| ex4Check.isChecked()|| ex5Check.isChecked())
                {
                    ...
                    TextView ex4Text = (TextView) findViewById(R.id.exercise_4_textview);

                    if(ex4Check.isChecked())
                    {
                        workoutDetails += ex4Text.getText() + "\n";
                    }

                    TextView ex5Text = (TextView) findViewById(R.id.exercise_5_textview);

                    if(ex5Check.isChecked())
                    {
                        workoutDetails += ex5Text.getText() + "\n";
                    }
                    ...
                    ex4Check.setChecked(false);
                    ex5Check.setChecked(false);
                }
                else{

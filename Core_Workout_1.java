...
public class Core_Workout_1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_core_workout_1);
        saveButton();
    }
    ...
    private void saveButton() {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ex1Check.isChecked() || ex2Check.isChecked() || ex3Check.isChecked()|| ex4Check.isChecked())
                {
